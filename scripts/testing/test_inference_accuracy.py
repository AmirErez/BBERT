...
class TestInferenceAccuracy(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Get BBERT root directory (go up from scripts/testing/)
        cls.bbert_dir = Path(__file__).parent.parent.parent
        cls.example_dir = cls.bbert_dir / "examples" / "data"
